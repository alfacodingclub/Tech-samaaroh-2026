...
const ClubPage = () => {
    ...
    alfa: {
      ...
      team: [
        ...
        },
        {
          ...
          image:
            "/WebAssets/alfa/alfa-core/WhatsApp Image 2026-01-30 at 2.47.54 PM.jpeg",
        },
        {
          name: "Abhinav Mehta",
          role: "Core Member",
        ...
        },
        {
          ...
          role: "Core Member",
          image:
            "/WebAssets/alfa/alfa-core/WhatsApp Image 2026-01-30 at 7.57.24 AM.jpeg",
        },
        {
          name: "Sahil Handa",
          role: "Core Member",
          image:
            "/WebAssets/alfa/alfa-core/WhatsApp Image 2026-01-30 at 7.58.07 AM.jpeg",
        },
        {
          name: "Megha Bhagat",
          role: "Core Member",
        ...
        },
        {
          ...
          role: "Core Member",
          image:
            "/WebAssets/alfa/alfa-core/WhatsApp Image 2026-01-30 at 7.57.24 AM (1).jpeg",
        },
        {
          name: "Yugal Bisht",
          role: "Core Member",
  ...
  return (
    <div
      key={club.id}
      className="relative w-full text-white font-sans min-h-screen pb-20 overflow-hidden bg-[#0a0a0a]"
    >
                ...
                {club?.team?.map((member, i) => (
                  ...
                  >
                    ...
                    <div className="md: flex flex-col items-start justify-center">
                      <h4 className="text-white text-left font-bold text-sm tracking-wide">
                        {member.name}
                      </h4>
                      <p className="text-[10px] text-[#e99b63] font-bold uppercase tracking-[0.2em] mt-1 italic text-left">
                        {member.role}
                      </p>
                    </div>
                  </div>
